  ...
  */ 
  ...
  return (
    <main className="w-full max-w-2xl mx-auto">
      ...
      {/* <!-- Mensagem de Sucesso --> */}
      <div className="glass-card p-10 text-center w-full hidden">
        ...
        <button className="btn-gold px-8 py-3 rounded-lg font-semibold" onClick={() => setIsFormVisible(false)}> {/* onClick={resetView}  */}
          Voltar ao Início
        </button>
      </div>
    </main>
